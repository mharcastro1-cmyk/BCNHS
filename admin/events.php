...
if (isset($_POST['submit'])) {
    ...
    if (!in_array($extension, ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
        ...
        if (move_uploaded_file($file, $targetFile)) {
            $eventsModule->createEvent($title, $overview, $content, $date, $location, $filename);
            echo "
            <script>
        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                ...
                <div style="background: var(--color-surface); border-radius: 12px; padding: 2rem; box-shadow: 0 4px 12px rgba(12, 22, 43, 0.08); margin-bottom: 2rem;">
                    <h2 style="font-size: 1.8rem; font-weight: 700; color: var(--color-text); margin-bottom: 1.5rem;">Add Event</h2>
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div style="margin-bottom: 1rem;">
                            ...
                            <textarea name="content" id="event-editor" placeholder="Enter Event Content" required style="width: 100%; padding: 0.75rem; border: 1px solid var(--color-border); border-radius: 8px; font-size: 1rem; box-sizing: border-box; min-height: 200px;"></textarea>
                        </div>
                        <div style="margin-bottom: 1rem;">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary" style="padding: 0.75rem 2rem; font-weight: 600;">Add Event</button>
                    </form>
                </div>
